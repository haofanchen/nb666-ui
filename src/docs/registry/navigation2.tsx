import { Affix, Anchor, BackTop, Button, Dropdown, Icon, Steps } from "nb666-ui"
...
export const navigationComponents2: ComponentDoc[] = [
  {
    ...
    importCode: `import { Dropdown } from "nb666-ui"`,
    demos: [
      {
        id: "basic",
        title: "基础用法",
        description: "点击触发，onSelect 返回选中的 key。",
        code: `import { Button, Dropdown, Icon } from "nb666-ui"
...
export default function Demo() {
  ...
  },
  {
    ...
    importCode: `import { Steps } from "nb666-ui"`,
    demos: [
      {
        id: "basic",
        title: "基础用法",
        description: "current 表示当前步骤，已完成步骤显示勾选。",
        code: `import { Steps } from "nb666-ui"
...
export default function Demo() {
  ...
  },
  {
    ...
    importCode: `import { Affix } from "nb666-ui"`,
    demos: [
      {
        id: "basic",
        title: "基础用法",
        description: "使用 sticky 定位，offsetTop 控制吸顶距离。",
        code: `import { Affix, Button } from "nb666-ui"
...
export default function Demo() {
  ...
  },
  {
    ...
    importCode: `import { BackTop } from "nb666-ui"`,
    demos: [
      {
        id: "basic",
        title: "基础用法",
        description: "默认 fixed 在右下角，示例改为 static 展示。",
        code: `import { BackTop } from "nb666-ui"
...
export default function Demo() {
  ...
  },
  {
    ...
    importCode: `import { Anchor } from "nb666-ui"`,
    demos: [
      {
        id: "basic",
        title: "基础用法",
        description: "配合 getContainer 指定滚动容器，滚动时自动高亮对应项。",
        code: `import { Anchor } from "nb666-ui"

export default function Demo() {
  const items = [
    { key: "1", href: "#nb666-anchor-demo-1", title: "基本信息" },
    { key: "2", href: "#nb666-anchor-demo-2", title: "表单设置" },
    { key: "3", href: "#nb666-anchor-demo-3", title: "提交说明" },
  ]
  return (
    <div className="flex gap-4">
      <Anchor
        ...
        getContainer={() => document.getElementById("nb666-anchor-demo")!}
      />
      <div id="nb666-anchor-demo" className="h-40 flex-1 space-y-6 overflow-y-auto pr-2">
        <section id="nb666-anchor-demo-1">
          <h3 className="font-medium">基本信息</h3>
          <p className="text-sm text-muted-foreground">填写项目名称与负责人。</p>
        </section>
        <section id="nb666-anchor-demo-2">
          <h3 className="font-medium">表单设置</h3>
          <p className="text-sm text-muted-foreground">配置字段、校验与默认值。</p>
        </section>
        <section id="nb666-anchor-demo-3">
