import { Breadcrumb, Button, Icon, Menu, Pagination, Tabs } from "nb666-ui"
...
export const navigationComponents: ComponentDoc[] = [
  {
    ...
    importCode: `import { Breadcrumb } from "nb666-ui"`,
    demos: [
      {
        id: "basic",
        title: "基础用法",
        description: "通过 items 配置每一级面包屑。",
        code: `import { Breadcrumb } from "nb666-ui"
  ...
  return (
    ...
    />
      ...
      },
      {
        ...
        code: `import { Breadcrumb, Icon } from "nb666-ui"
...
export default function Demo() {
  ...
  },
  {
    ...
    importCode: `import { Tabs } from "nb666-ui"`,
    demos: [
      {
        id: "basic",
        title: "基础用法",
        description: "默认选中第一项，通过 onChange 监听切换。",
        code: `import { Tabs } from "nb666-ui"
  ...
  return (
    ...
    />
      ...
      },
      {
        ...
        code: `import { Icon, Tabs } from "nb666-ui"
  ...
  return (
    ...
    />
      ...
      },
      {
        ...
        code: `import { Button, Tabs } from "nb666-ui"
...
export default function Demo() {
  ...
  },
  {
    ...
    importCode: `import { Pagination } from "nb666-ui"`,
    demos: [
      {
        id: "basic",
        title: "基础用法",
        description: "通过 total 与 pageSize 计算总页数。",
        code: `import { Pagination } from "nb666-ui"
...
export default function Demo() {
  ...
  },
  {
    ...
    importCode: `import { Menu } from "nb666-ui"`,
    demos: [
      {
        id: "inline",
        title: "内嵌菜单",
        description: "默认 mode 为 inline，支持多级子菜单。",
        code: `import { Icon, Menu } from "nb666-ui"
